...
const PizzaCustomization = () => {
  ...
  return (
    <div className="flex flex-col items-center mb-10 gap-12">
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-8 w-full">
        <Select
          variant="faded"
          label="Pick Your Crust"
          selectedKeys={selectedBaseId ? new Set([selectedBaseId]) : new Set()}
      ...
      <CheckboxGroup
        classNames={{ label: "text-semibold" }}
        color="success"
